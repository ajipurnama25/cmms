...
# def check_postgres_connection(pg_host, pg_database, pg_user, pg_password):
#     try:
...
# check_postgres_connection(pg_host, pg_database, pg_user, pg_password)
